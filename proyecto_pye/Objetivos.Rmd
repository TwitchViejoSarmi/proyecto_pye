...
-   Para la categoría de **centro poblado,** se puede apreciar una poca dispersión de los registros de los pesos de los bebés recién nacidos dentro de los limites de los mismos datos.
...
-   Se observa una gran diferencia en la distribución de la talla de los pesos por **Área de residencia.** Se observa que la categoría **Cabezera municipal** posee una mayor frecuencia para los pesos mayores a 3 kilogramos y menores a 4 kilogramos (Ver Figura 2) cuyo valor es mayor a 500 bebés.
...
-   Todas las curvas muestran un aumento pronunciado en la frecuencia acumulada en el rango de aproximadamente de 2 a 4 kilogramos. Esto indica que la mayoría de los nacimientos ocurren en este rango de peso, lo cual es consistente con el peso promedio al nacer esperado (Ver Figura 3 y Tabla 1).

-   La distribución del peso al nacer es más desigual en la **Cabezera municipal** que en el **Centro poblado** y en el **Área rural disperso** (Ver Figura 3).
...
-   En los **Centros poblados** , los partos espontáneos son parecidamente comunes que los partos por cesarea aunque estos últimos se presentan en una ligera menor cantidad (Ver Figura 4 y Tabla 2).

-   La **cabecera municipal** tiene una mayor cantidad total de partos en comparación con las **áreas rurales dispersas** y los **centros poblados** (Ver Figura 4 y Tabla 2).

-   Tanto en la **cabecera municipal** como en las **áreas rurales dispersas** y los **centros poblados** los partos espontáneos son los más frecuentes, seguidos por las cesáreas (Ver Figura 4 y Tabla 2).

-   Para las **cabeceras municipales** se registran una minima cantidad de partos instrumentados no superando aproximadamente los 13 partos mientras que en los **centros poblados** o **áreas rurales dispersas** es dato es casi nulo (Ver Figura 4 y Tabla 2).
...
-   $H_0: \epsilon$ se distribuye normal

-   $H_1 \epsilon$ no se distribuye normal
